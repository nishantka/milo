...
const decoratePromo = (elem, index) => {
  ...
  const actualText = elem.querySelector('.feds-promo-content a').textContent;
  elem.querySelector('.feds-promo-content a')?.setAttribute('aria-label', `${description} ${actualText}`);
