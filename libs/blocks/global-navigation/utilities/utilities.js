...
export const transformTemplateToMobile = async (popup, item, localnav = false) => {
  ...
  const mainMenu = `
      <span class="main-menu" daa-ll="Main menu_Gnav|gnav|${getAnalyticsValue(item.textContent)}"  daa-lh="gnav">
  ...
  popup.innerHTML = `
    <div class="top-bar">
      ...
      <span class="close-icon" daa-ll="Close button_SubNav|gnav|${getAnalyticsValue(item.textContent)}"  daa-lh="gnav">
