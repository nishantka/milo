...
class Gnav {
  ...
  decorateLocalNav = async () => {
    ...
    if (this.elements.localNav || !this.newMobileNav || isDesktop.matches) {
      ...
      localNav.append(toFragment`<button class="feds-navLink--hoverCaret feds-localnav-title" daa-ll="${title}_localNav" daa-lh="gnav"></button>`, toFragment` <div class="feds-localnav-items"></div>`);
